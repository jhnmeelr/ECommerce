...
export function register({ email, repeatEmail, name, password, address, postcode, city }) {
  if (!email || !repeatEmail || !name || !password || !name || !address || !postcode || !city) {
    return {
      type: REGISTER_ERROR,
  ...
  return dispatch => {
    ...
    post('/register', { email, name, password, address, postcode, city })
