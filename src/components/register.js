...
class Register extends React.Component {
  ...
  render() {
    const { register, changeToLogin, loading, error } = this.props;
      ...
      <View style={{ flex: 1 }}>
        <Content>
          <Form>
            ...
            <Button block style={{ margin: 20 }} onPress={() => register({ ...this.state })}>
              <Text>Register</Text>
            </Button>
          </Form>

          <LinkButton title={'or Login'} onPress={() => changeToLogin()}/>
